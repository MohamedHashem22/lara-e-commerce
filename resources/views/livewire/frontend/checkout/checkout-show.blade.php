    ...
    <div class="py-3 py-md-4 checkout">
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12 mb-4">
                    <div class="shadow bg-white p-3">
                        <h4 class="text-primary mb-2" style="font-weight: bold; font-size=35px;">
                            Item Total Amount :
                ...
                <div class="col-md-12">
                    <div class="shadow bg-white p-3">
                        <h4 class="text-primary mb-3" style="font-weight: bold; font-size=35px;">
                            Basic Information
                        </h4>
                        <hr>
                        <br>
                        ...
                        <form action="" method="POST">
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" name="fullname" wire:model.defer="fullname" class="form-control"
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" name="pincode" wire:model="pincode" class="form-control"
                                        placeholder="Enter Pin-code" />
                                        @error('pincode') <small class="text-danger">{{ $message }}</small>@enderror
                                </div>
                                <div class="col-md-12 mb-3">
                                    <label>Full Address</label>
                                    <textarea name="address" wire:model="address" class="form-control"
                                        rows="2"></textarea>
                                    ...
                                    <div class="d-md-flex align-items-start">
                                        ...
                                        <div class="tab-content col-md-9" id="v-pills-tabContent">
                                            <div class="tab-pane fade" id="cashOnDeliveryTab" role="tabpanel"
                                                ...
                                                <hr />
                                                <button type="button" wire:click="codeOrder"
                                                    class="btn btn-primary">Place Order (Cash on Delivery)</button>
            ...
            <div class="card card-body shadow text-center">
                <span style="font-size:28px; font-weight:bold; word-spacing:-2px;"> No Item In Cart To CheckOut </span>
                <br>
